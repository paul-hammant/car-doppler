...
import { DebugConsoleTestHarness } from './DebugConsoleTestHarness'; // The component to hydrate
...
if (rootElement) {
    try {
        ...
        if (propsString) {
            ...
            console.log('Hydrating DebugConsoleTestHarness with props:', props);
        } else {
        ...
        // Ensure that the props are what DebugConsoleTestHarness expects.
        // For example, testName is required by DebugConsoleTestHarness.
        ...
        hydrateRoot(rootElement, <DebugConsoleTestHarness {...props} />);
        console.log('DebugConsoleTestHarness hydration complete.');
